...
export default function PreviewHome() {
  return (
    <main
      className={`${roboto.className} relative -mt-[72px] flex min-h-[100svh] flex-col overflow-hidden`}
    >
      {/* Preview-only: hide the global fixed navbar so the full-bleed hero shows through */}
